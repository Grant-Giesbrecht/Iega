...
public:
    ...
    bool add_variable(std::string var_id, KMatrix<double> val, std::string comment="");
	bool add_variable(std::string var_id, KMatrix<std::string> val, std::string comment="");
	bool add_variable(std::string var_id, KMatrix<bool> val, std::string comment="");
//    bool add_variable(std::string var_id, Eigen::MatrixXd& val, std::string comment="");
    ...
    bool set_variable(std::string var_id, KMatrix<double> val);
	bool set_variable(std::string var_id, KMatrix<std::string> val);
	bool set_variable(std::string var_id, KMatrix<bool> val);
//    bool set_variable(std::string var_id, Eigen::MatrixXd& val);
    ...
    bool get_variable(std::string var_id, KMatrix<double>& output);
	bool get_variable(std::string var_id, KMatrix<std::string>& output);
	bool get_variable(std::string var_id, KMatrix<bool>& output);
//    bool get_variable(std::string var_id, Eigen::MatrixXd& val);
	...
	bool add_matrix(std::string var_id, KMatrix<double>& val, std::string comment="");
	bool add_matrix(std::string var_id, KMatrix<std::string>& val, std::string comment="");
	bool add_matrix(std::string var_id, KMatrix<bool>& val, std::string comment="");
	bool get_matrix(std::string var_id, KMatrix<double>& out);
	bool get_matrix(std::string var_id, KMatrix<std::string>& out);
	bool get_matrix(std::string var_id, KMatrix<bool>& out);
    bool set_matrix(std::string var_id, KMatrix<double> in);
	bool set_matrix(std::string var_id, KMatrix<std::string> in);
	bool set_matrix(std::string var_id, KMatrix<bool> in);
...
//    bool load_file(std::string filename, long& fail_line);
    bool load_KV1(std::string filename, bool header_only=false);
    bool load_KV2(std::string filename, bool header_only=false);
    bool load_KV3(std::string filename, bool header_only=false);
    bool load_KV1(std::string filename, long& fail_line, bool header_only=false);
    bool load_KV2(std::string filename, long& fail_line, bool header_only=false);
    bool load_KV3(std::string filename, long& fail_line, bool header_only=false);
