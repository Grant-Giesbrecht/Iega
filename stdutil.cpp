...
/*
 Adds and returns all elements in 'v'
...
/*
 Finds the max value in 'v'. Returns -1 if empty
 
 v - vector in which to find max
 
 Max value in 'v'
 */
double vmax(std::vector<double> v){
...
/*
 Finds the min value in 'v'. Returns -1 if empty
 
 v - vector in which to find min
 
 Min value in 'v'
 */
double vmin(std::vector<double> v){
	if (v.size() == 0) return -1;
